...
def update_patient(patient_id:str,patient_upadate:Patientupdate):
    data=load_data()
    ...
    updated_patient_info=patient_upadate.model_dump(exclude_unset=True) 
    
    for key,value in updated_patient_info.items():
        existing_patient_info[key]=value
    
    #existing_patient_info ->pydantic objects ->uodated bmi+verdict
...
def delete_patient(patient_id:str):
    ...
    return JSONResponse(status_code=200,content={'message':'patient delete successfullly '})    
